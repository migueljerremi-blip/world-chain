...
pub(crate) struct PayloadBuilderMetrics {
    ...
    /// Flashblocks per block metric.
    pub(crate) flashblocks_per_block: Counter,
    /// Total failovers while building flashblocks.
    pub(crate) revoked_authorizations: Counter,
    /// Total number of flashblocks built.
    pub(crate) built_flashblocks: Counter,
}
